<?php
	...
	$p = $post[0];
?>
<ad-header><i class="fas fa-gavel"></i> Censorship Edit</ad-header>
...
action="/Submit/main.php?n=postUpdate&id=<?php echo $id ?>">
	...
	<?php if(!$p['status']){ //If uncensored ?>
		<button>
			<a href="/Submit/main.php?n=censorship&s=1&id=<?php echo $p['id'] ?>">
				<i class="fas fa-check"></i> Approved</a>
		</button>

		<button>
			<a href="/admincp/Censorship">
				<i class="fas fa-times"></i> Postponed</a></button>
	<?php }else{ ?>
		<button type="submit">Update</button>

		<button>
			<a href="/Submit/main.php?n=censorship&s=0&id=<?php echo $p['id'] ?>" class="confirm">
